...
function parseMarkdown(e){if(!e)return"";var t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\`\`\`([\\s\\S]*?)\`\`\`/g,"<pre><code>$1</code></pre>").replace(/\`([^\`]+)\`/g,'<code class="inline">$1</code>').replace(/\\*\\*([^*]+)\\*\\*/g,"<strong>$1</strong>").replace(/__([^_]+)__/g,"<strong>$1</strong>").replace(/\\*([^*]+)\\*/g,"<em>$1</em>").replace(/_([^_]+)_/g,"<em>$1</em>").replace(/~~([^~]+)~~/g,"<del>$1</del>").replace(/\\[([^\\]]+)\\]\\(([^)]+)\\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>').replace(/!\\[([^\\]]*)\\]\\(([^)]+)\\)/g,'<img src="$2" alt="$1" class="md-image" loading="lazy">').replace(/^&gt;\\s*(.+)$/gm,"<blockquote>$1</blockquote>").replace(/^[\\-\\*]\\s+(.+)$/gm,"<li>$1</li>").replace(/^\\d+\\.\\s+(.+)$/gm,"<li>$1</li>").replace(/^### (.+)$/gm,"<h3>$1</h3>").replace(/^## (.+)$/gm,"<h2>$1</h2>").replace(/^# (.+)$/gm,"<h1>$1</h1>").replace(/^---$/gm,"<hr>").replace(/\\n/g,"<br>");return t}
function hasMarkdown(e){if(!e)return!1;return[/\`\`\`[\\s\\S]*?\`\`\`/,/\`[^\`]+\`/,/\\*\\*[^*]+\\*\\*/,/__[^_]+__/,/\\*[^*]+\\*/,/_[^_]+_/,/~~[^~]+~~/,/\\[[^\\]]+\\]\\([^)]+\\)/,/!\\[.*\\]\\(.*\\)/,/^&gt;\\s*/m,/^[\\-\\*]\\s+/m,/^\\d+\\.\\s+/m,/^#{1,3}\\s+/m,/^---$/m].some(function(t){return t.test(e)})}
